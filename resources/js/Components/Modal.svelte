    ...
    <div bind:this={dialog} style:display={show ? 'contents' : 'none'}>
        ...
        >
            ...
            >
                ...
                <button
                    class="fixed inset-0 transition-all transform-select-none"
                    onclick={close}
                >
                    <div
            ...
            >
                <div
                    class="mb-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:mx-auto {maxWidthClass}"
                >
                    {@render children()}
                </div>
            </div>
